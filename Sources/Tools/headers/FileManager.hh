...
// Last update Mon Feb  9 18:17:14 2015 ovoyan_s
//
...
private:
  ...
  std::pair<std::string, std::string>	getPairAtString(const std::string& strToUse);
...
public:
  ...
  std::map<std::string, std::string>	getConfigContent();
